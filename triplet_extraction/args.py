...
def _add_common_args(arg_parser,mode_type):
    if mode_type=="train":
        arg_parser.add_argument('--config',default="configs/example_train.conf", type=str) # config 参数传入
    elif mode_type=="eval":
        arg_parser.add_argument('--config',default="configs/example_eval.conf", type=str)
    elif mode_type=="predict":
        arg_parser.add_argument('--config',default="configs/example_predict.conf", type=str)
...
def train_argparser():
    ...
    _add_common_args(arg_parser,"train")
...
def eval_argparser():
    ...
    _add_common_args(arg_parser,"eval")
    _add_logging_args(arg_parser)
...
def predict_argparser():
    ...
    _add_common_args(arg_parser,"predict")
